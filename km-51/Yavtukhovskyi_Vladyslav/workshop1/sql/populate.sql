...
insert into weakness_has_syndrom values ('broken leg', 'leg is broken');
insert into weakness_has_syndrom values ('broken arm', 'arm is broken');
insert into weakness_has_syndrom values ('broken arm and achu', 'arm is broken');
insert into weakness_has_syndrom values ('broken arm and achu', 'Achu');

insert into medicine_is_for_weakness values ('new arm', 'broken arm');
insert into medicine_is_for_weakness values ('new leg', 'broken leg');
insert into medicine_is_for_weakness values ('pika', 'good day sir');
insert into medicine_is_for_weakness values ('pika', 'broken arm and achu');

insert into healing_histories(id, num_of_record, login_fk, name_of_medicine_fk, name_of_weakness_fk, name_of_syndrom_fk) values (1, 1,
'expo12', 'pika', 'broken arm and achu', 'Achu');

insert into healing_histories(id, num_of_record, login_fk, name_of_medicine_fk, name_of_weakness_fk, name_of_syndrom_fk) values (2, 2,
'expo22', 'new arm', 'broken arm and achu', 'arm is broken');

insert into healing_histories(id, num_of_record, login_fk, name_of_medicine_fk, name_of_weakness_fk, name_of_syndrom_fk) values (3, 2,
'expo22', 'pika', 'broken arm and achu', 'Achu');

insert into healing_histories(id, num_of_record, login_fk, name_of_medicine_fk, name_of_weakness_fk, name_of_syndrom_fk) values (4, 1,
